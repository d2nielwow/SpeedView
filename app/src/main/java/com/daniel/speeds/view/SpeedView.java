package com.daniel.speeds.view;
...
public class SpeedView extends View {
    ...
    private void init(Context context, AttributeSet attrs){
        if (attrs != null){
            ...
            color = a.getInt(R.styleable.SpeedView_color, 0xff98ffb0);
            textColor = a.getInt(R.styleable.SpeedView_textColor, 0xff90a0ff);
